...
#python evaluate.py --network D:\subjects\BTP\robotic-grasping\output\models\200723_1456_training_cornell\epoch_23_iou_0.90 --dataset cornell --dataset-path D:\subjects\BTP\dataset_2 --iou-eval
