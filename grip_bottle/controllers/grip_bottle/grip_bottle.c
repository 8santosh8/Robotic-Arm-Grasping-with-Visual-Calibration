   ...
   //   wb_motor_set_position(robot_parts[40],0.70);
     ...
     // wb_motor_set_position(robot_parts[16],0.60);
      ...
      case WB_KEYBOARD_DOWN:
        wb_motor_set_position(robot_parts[6],1.70);
        break;
     case WB_KEYBOARD_RIGHT: 
     // wb_motor_set_position(robot_parts[11],0.40);
      wb_motor_set_position(robot_parts[12],0.30);
     // wb_motor_set_position(robot_parts[13],0.30);
      wb_motor_set_position(robot_parts[14],0.30); 
       wb_motor_set_position(robot_parts[17],0.40);    
      wb_motor_set_position(robot_parts[19],0.40);
       wb_motor_set_position(robot_parts[21],0.40);
      wb_motor_set_position(robot_parts[24],0.40);
      wb_motor_set_position(robot_parts[26],0.40);
       wb_motor_set_position(robot_parts[28],0.40);
