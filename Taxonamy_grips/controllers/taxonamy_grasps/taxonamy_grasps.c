...
static void check_keyboard() {
  ...
  if (key >= 0) {
    switch (key) {
      ...
      wb_motor_set_position(robot_parts[10],1.40);
      wb_motor_set_position(robot_parts[11],0.79);
      wb_motor_set_position(robot_parts[14],0.79);
      wb_motor_set_position(robot_parts[15],0.52);
      wb_motor_set_position(robot_parts[17],0.70);
     ...
     case WB_KEYBOARD_RIGHT:
      wb_motor_set_position(robot_parts[10],0.00);
      wb_motor_set_position(robot_parts[11],0.00);
      wb_motor_set_position(robot_parts[14],0.00);
      wb_motor_set_position(robot_parts[15],0.00);
      wb_motor_set_position(robot_parts[17],0.00);
      wb_motor_set_position(robot_parts[19],0.00);
      wb_motor_set_position(robot_parts[21],0.00);
      wb_motor_set_position(robot_parts[16],0.00);
      wb_motor_set_position(robot_parts[16],0.70);
      wb_motor_set_position(robot_parts[17],0.70);
      wb_motor_set_position(robot_parts[18],0.70);
      wb_motor_set_position(robot_parts[19],0.70);
      wb_motor_set_position(robot_parts[23],0.70);
      wb_motor_set_position(robot_parts[24],0.70);
      wb_motor_set_position(robot_parts[25],0.70);
      wb_motor_set_position(robot_parts[26],0.70);
      wb_motor_set_position(robot_parts[30],0.70);
      wb_motor_set_position(robot_parts[31],0.70);
      wb_motor_set_position(robot_parts[32],0.70);
      wb_motor_set_position(robot_parts[33],0.70);
      wb_motor_set_position(robot_parts[37],0.70);
      wb_motor_set_position(robot_parts[38],0.70);
      wb_motor_set_position(robot_parts[39],0.70);
      wb_motor_set_position(robot_parts[40],0.70);
        break;
      case WB_KEYBOARD_LEFT:
      wb_motor_set_position(robot_parts[10],1.40);
      wb_motor_set_position(robot_parts[11],0.30);
      wb_motor_set_position(robot_parts[12],0.40);
      wb_motor_set_position(robot_parts[13],0.50);
      wb_motor_set_position(robot_parts[14],0.60);
      wb_motor_set_position(robot_parts[15],0.79);
        break;
      case WB_KEYBOARD_DOWN:
      wb_motor_set_position(robot_parts[18],0.00);
      wb_motor_set_position(robot_parts[19],0.00);
      wb_motor_set_position(robot_parts[25],0.00);
      wb_motor_set_position(robot_parts[26],0.00);
      wb_motor_set_position(robot_parts[32],0.00);
      wb_motor_set_position(robot_parts[33],0.00);
      wb_motor_set_position(robot_parts[39],0.00);
      wb_motor_set_position(robot_parts[40],0.00);
      wb_motor_set_position(robot_parts[12],0.00);
      wb_motor_set_position(robot_parts[13],0.00);
      wb_motor_set_position(robot_parts[14],0.00);
      wb_motor_set_position(robot_parts[15],0.00);
        break;
    }
...
int main(int argc, char **argv) {
  ...
  double target_pos[N_PARTS] = {0.24,  -0.67, 0.20, 0.20, 0.00 , -1.50, 1.52, 1.32,    0.00,   2.00, 0.00,  0.00,
